...
describe(
    ...
    () =>
    {
        ...
        it(
            "should print a basic call expression",
            () =>
            {
                doTest(
                    {
        ...
        it(
            "should print with a type argument", () =>
        {
            doTest(
                {
                    property: undefined,
        ...
        it(
            "should print with type arguments",
            () =>
            {
                doTest(
                    {
    ...
    () =>
    {
        ...
        describe(
            ...
            () =>
            {
                ...
                it(
                    "should print the next identifier separated by a period",
                    () =>
                    {
                ...
                it(
                    "should print the next computed value with no separation",
                    () =>
                    {
        ...
        describe(
            ...
            () =>
            {
                ...
                it(
                    "should print with a property after",
                    () =>
                    {
        ...
        describe(
            ...
            {
                it(
                    "should print with no arguments",
                    () =>
                    {
        ...
        describe(
            ...
            {
                it(
                    "should print the array with no elements",
                    () =>
                    {
                ...
                it(
                    "should print the array with one element",
                    () =>
                    {
                ...
                it(
                    "should print the array with multiple elements",
                    () =>
                    {
        ...
        describe(
            ...
            {
                it(
                    "should print when it has no argument",
                    () =>
                    {
                ...
                it(
                    "should print when it receives an identifier",
                    () =>
                    {
                ...
                it(
                    "should print when it receives a string literal",
                    () =>
                    {
                ...
                it(
                    "should print when it has a typeof",
                    () =>
                    {
        ...
        describe(
            ...
            {
                it(
                    "should print when only has a string",
                    () =>
                    {
                ...
                it(
                    "should print when also has an interpolate node",
                    () =>
                    {
