...
export function runCommonTests(getTransformedText: (text: string) => string, options: ITestOptions = {}): void
{
        ...
        () =>
        {
            ...
            describe(
                ...
                () =>
                {
                    ...
                    it(
                        "should get the result of the super keyword",
                        () =>
                        {
                            runTest(
            ...
            describe(
                ...
                () =>
                {
                    ...
                    it(
                        "should throw when a nameof.interpolate is not used inside a nameof.full",
                        () =>
                        {
                    ...
                    it(
                        "should handle the scenarios in issue #104",
                        () =>
                        {
    ...
    describe(
        ...
        () =>
        {
            ...
            it(
                "should throw when the function argument does not return an array",
                () =>
                {
                    runThrowTest(
    ...
    describe(
        ...
        () =>
        {
            ...
            it(
                "should replace handling comments",
                () =>
                {
...
`;
            ...
            it(
                "should replace handling strings",
                () =>
                {
                    const input = `nameof(window);
const t = /\`/g;
    ...
    function runThrowTest(text: string, possibleExpectedMessages: string | string[]): void
    {
        ...
        function getPossibleExpectedMessages(): string[]
        {
            ...
            for (let i = result.length - 1; i >= 0; i--)
            {
                ...
                // babel
                const babelPath = path.resolve(__dirname, "../../babel-transformer/src/tests/test.ts");
                ...
                result.push(`${path.resolve(__dirname, "../../babel-macro/src/tests/test.ts")}: ./ts-nameof.macro: [ts-nameof]: ${originalText}`);
            }
