 ...
 */
export class BabelTransformer extends TransformerBase<ITransformTarget, BabelFeatures>
{
    /**
     ...
     */
    protected get Transformer(): NameofNodeTransformer<ITransformTarget, babel.Node>
    {
