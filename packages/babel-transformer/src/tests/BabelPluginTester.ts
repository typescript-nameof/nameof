 ...
 */
export class BabelPluginTester extends TransformerTester<ITransformTarget>
{
    /**
     * @inheritdoc
     *
     ...
     */
    protected async Run(code: string, errorHandler?: IErrorHandler<ITransformTarget>): Promise<string>
    {
